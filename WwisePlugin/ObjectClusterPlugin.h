...
class ObjectClusterPlugin final
...
DECLARE_AUDIOPLUGIN_CONTAINER(ObjectCluster);	// Exposes our PluginContainer structure that contains the info for our plugin
