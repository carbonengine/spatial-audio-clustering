...
#ifndef ObjectClusterConfig_H
#define ObjectClusterConfig_H
...
namespace ObjectClusterConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 6973;
}

#endif // ObjectClusterConfig_H
