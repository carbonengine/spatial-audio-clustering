...
#ifndef BinauralObjectProcessorConfig_H
#define BinauralObjectProcessorConfig_H
...
namespace BinauralObjectProcessorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 31251;
}

#endif // BinauralObjectProcessorConfig_H
