...
class BinauralObjectProcessorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    BinauralObjectProcessorPlugin();
    ~BinauralObjectProcessorPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(BinauralObjectProcessor);	// Exposes our PluginContainer structure that contains the info for our plugin
