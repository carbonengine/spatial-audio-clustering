...
local Plugin = {}
Plugin.name = "BinauralObjectProcessor"
Plugin.factoryheader = "../SoundEnginePlugin/BinauralObjectProcessorFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
{
    "BinauralObjectProcessorFXShared.cpp"
}
...
{
    "BinauralObjectProcessorFXShared.cpp",
    "BinauralObjectProcessorFXFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "BinauralObjectProcessor.def",
    "BinauralObjectProcessor.xml",
    "**.rc",
}
