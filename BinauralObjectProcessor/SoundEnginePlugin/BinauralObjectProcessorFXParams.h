...
#ifndef BinauralObjectProcessorFXParams_H
#define BinauralObjectProcessorFXParams_H
...
struct BinauralObjectProcessorRTPCParams
{
    AkReal32 fPlaceholder;
};

struct BinauralObjectProcessorNonRTPCParams
{
};

struct BinauralObjectProcessorFXParams
    : public AK::IAkPluginParam
{
    BinauralObjectProcessorFXParams();
    BinauralObjectProcessorFXParams(const BinauralObjectProcessorFXParams& in_rParams);
    ...
    BinauralObjectProcessorRTPCParams RTPC;
    BinauralObjectProcessorNonRTPCParams NonRTPC;
};

#endif // BinauralObjectProcessorFXParams_H
