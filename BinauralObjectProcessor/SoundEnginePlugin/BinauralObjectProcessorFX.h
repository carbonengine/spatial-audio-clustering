...
#ifndef BinauralObjectProcessorFX_H
#define BinauralObjectProcessorFX_H
...
class BinauralObjectProcessorFX
	: public AK::IAkOutOfPlaceObjectPlugin
{
public:
	BinauralObjectProcessorFX();
	~BinauralObjectProcessorFX();
...
private:
	BinauralObjectProcessorFXParams* m_pParams;
	AK::IAkPluginMemAlloc* m_pAllocator;
	AK::IAkEffectPluginContext* m_pContext;
};

#endif // BinauralObjectProcessorFX_H
